...
public class SameSiteAttributeTest {
    ...
    static SameSiteAttribute library;

    @BeforeAll
    public static void setup() {
        library = new SameSiteAttribute();
    }
...
//            "Firefox @ iOS 12",
    ...
    public void shouldSetSameSiteNoneFalsyUserAgents(String userAgent) {
        SameSiteAttribute library = new SameSiteAttribute();
        Assertions.assertFalse(library.shouldSetSameSiteNone(userAgent), "shouldSetSameSiteNone should return 'false'\t-\t[" + userAgent + "]\n");
    }
...
//            "Safari @ ios 13":
    ...
    public void shouldSetSameSiteNoneTruthyUserAgents(String userAgent) {
        Assertions.assertTrue(library.shouldSetSameSiteNone(userAgent), "shouldSetSameSiteNone should return 'true'\t-\t[" + userAgent + "]\n");
    }
}
